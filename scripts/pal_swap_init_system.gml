...
#define pal_swap_enable_override
...
#define pal_swap_get_color_count
///pal_swap_get_color_count(palette sprite)
return(sprite_get_height(argument[0]));


#define pal_swap_get_pal_color
